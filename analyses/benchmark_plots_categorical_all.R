...
ggsave("analyses/plots/benchmark_categorical_classif_datasets_all.pdf", width=15, height=10, bg="white")
...
ggsave("analyses/plots/benchmark_categorical_classif_poster_all.pdf", width=13.5, height=7, bg="white")

plot_aggregated_results(df, y_inf=0.5, y_sup=0.95, score="accuracy", max_iter=400)
ggsave("analyses/plots/benchmark_categorical_classif_all.pdf", width=7, height=6, bg="white")
...
ggsave("analyses/plots/benchmark_categorical_regression_datasets_all.pdf", width=15, height=10, bg="white")
...
ggsave("analyses/plots/benchmark_categorical_regression_all.pdf", width=13.5, height=7, bg="white")
