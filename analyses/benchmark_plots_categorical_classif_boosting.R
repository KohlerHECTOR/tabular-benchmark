...
ggsave("analyses/plots/random_search_classif_categorical_datasets_boosting.pdf", width=15, height=10, bg="white")


# Aggregated

plot_aggregated_results(df, y_inf=0.5, y_sup=0.95, score="accuracy", quantile=0.1, truncate_scores = F, max_iter = 100, equalize_n_iteration = T)
ggsave("analyses/plots/random_search_classif_categorical_boosting.pdf", width=7, height=6, bg="white")
