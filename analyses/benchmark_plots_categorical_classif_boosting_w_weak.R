...
ggsave("analyses/plots/random_search_classif_categorical_datasets_boosting_w_weak.pdf", width=15, height=10, bg="white")
...
ggsave("analyses/plots/random_search_classif_categorical_boosting_w_weak.pdf", width=7, height=6, bg="white")
