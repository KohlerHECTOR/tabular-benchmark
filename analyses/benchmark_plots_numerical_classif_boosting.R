...
benchmark <- read_csv("src/results_boosting_dpdt.csv") %>%
...
ggsave("analyses/plots/random_search_classif_numerical_datasets_boosting.pdf", width=15, height=10, bg="white")
...
ggsave("analyses/plots/random_search_classif_numerical_boosting_dpdt.pdf", width=7, height=6, bg="white")
