...
plot_aggregated_results_time(df, y_inf=0.8)

ggsave("analyses/plots/benchmark_time_numerical_classif_boosting.pdf", width=7, height=6, bg="white")
...
ggsave("analyses/plots/benchmark_time_categorical_classif_boosting.pdf", width=7, height=6, bg="white")