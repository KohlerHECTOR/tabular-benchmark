...
ggsave("analyses/plots/benchmark_time_numerical_classif_boosting_all.pdf", width=7, height=6, bg="white")
...
ggsave("analyses/plots/benchmark_time_categorical_classif_boosting_all.pdf", width=7, height=6, bg="white")