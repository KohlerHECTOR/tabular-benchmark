...
for i, row in df.iterrows():
    ...
    if use_gpu:
        ...
        OAR_COMMAND = """oarsub "source /home/hkohler/public/tabular-benchmark/cool_env/bin/activate;wandb agent {}/{}/{}" -l walltime=00:10:30 -p "not cluster='graphite' AND not cluster='grimani' AND not cluster='gruss'" -q production"""
